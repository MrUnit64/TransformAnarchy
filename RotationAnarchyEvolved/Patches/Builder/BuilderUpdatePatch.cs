...
namespace RotationAnarchyEvolved
{
    ...
    public class BuilderUpdatePatch
    {
        ...
        {
            bool doRestOfUpdate = BuilderUpdateSharedCode.Update<Builder>(ref ___ghost, ref ___ghostPos, ref ___rotation, ref ___actualBuiltObjects, ref ___ghostMaterial);
            Debug.Log($"Builder, doing rest of Update: {doRestOfUpdate}");
            return doRestOfUpdate;
        }
    }
}
